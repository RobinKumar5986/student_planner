...
import com.example.studentplanner.Models.uploadPDFs;
import com.example.studentplanner.databinding.ActivityPdfBinding;
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot postSnapshot: snapshot.getChildren()){
                    uploadPDFs uploadPDFs=postSnapshot.getValue(com.example.studentplanner.Models.uploadPDFs.class);
